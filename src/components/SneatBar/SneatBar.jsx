...
export default function SneatBar() {
  return (
    ...
    <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <div className="app-brand demo ">
        ...
        <a href="#anything" className="layout-menu-toggle menu-link text-large ms-auto">
      ...
      <ul className="menu-inner py-1">
        ...
        <li className="menu-item active open">
          ...
          <ul className="menu-sub">
            ...
            <li className="menu-item active open">
              <a href="#anything" className="menu-link menu-toggle">
            ...
            <li className="menu-item active open">
              ...
              <ul className="menu-sub">
                <li className="menu-item">
                  <Link to="/customer-all" className='menu-link'>
            ...
            <li className="menu-item">
                <Link to="/manage-reviews" className="menu-link">
